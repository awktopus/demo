...
@Component({
  selector: 'app-caseagreement',
  templateUrl: './caseagreement.component.html',
  styleUrls: ['./caseagreement.component.scss']
})
export class CaseagreementComponent implements OnInit {
  mycaseID: string;
  docId: string;
  seq: string;
