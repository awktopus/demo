import { LocalStorageService, PermissionStorage } from '../localStorage/local-storage.service';
...
export class UserService {
    constructor(private localDb: LocalStorageService, private ouService: OUService) {
    }
